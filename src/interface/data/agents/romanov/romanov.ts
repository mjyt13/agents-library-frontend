...
export const romanov: Agent = {
  id: 'romanov',
  name: "The Doctor' Romanov",
  description:
  ...
  comment:
    "Oldman really got his place in community. Some hate him, some adore him. And he's fun too ",
  photos: ['agents/romanov/1073944.png', 'agents/romanov/34063393-front@2x.webp'],
}
