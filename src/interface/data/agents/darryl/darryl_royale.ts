...
export const darryl_royale: Agent = {
  id: 'darryl_royale',
  name: 'Sir Bloody Royale Darryl',
  description:
  ...
  comment:
    "Right now it is the best agent in this game. Price, style, look - in every aspect he's higher than anyone",
  photos: ['agents/darryl/darryl_royale_sniper.webp', 'agents/darryl/darryl_royale_sniper.webp'],
}
