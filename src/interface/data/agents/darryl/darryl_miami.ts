...
export const darryl_miami: Agent = {
  id: 'darryl_miami',
  ...
  comment:
    "yeah, in cs2 he got worse mask but right now only expensiveness is the factor against - he's almost perfect",
  photos: ['agents/darryl/darryl_miami_tpose.webp', 'agents/darryl/darryl_miami.webp'],
}
