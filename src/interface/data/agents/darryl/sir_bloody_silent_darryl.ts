...
export const sir_bloody_silent_darryl: Agent = {
  id: 'sir_bloody_silent_darryl',
  name: 'Sir Bloody Silent Darryl',
  description:
  ...
  comment: '',
  rarity: 'Master',
  photos: ['agents/darryl/sir_bloody_silent_darryl.webp'],
}
// вариация: перенеси sir_bloody_silent_darryl.ts и sir_bloody_silent_darryl.webp в agents/darryl/
