...
const pageOneCategories: VoiceCategoryConfig[] = [
  { id: voiceCategory.AFFIRMATIVE, name: 'Affirmative', page: 1, alwaysShow: true },
  { id: voiceCategory.NEGATIVE, name: 'Negative', page: 1, alwaysShow: true },
  { id: voiceCategory.AGREE, name: 'Agree', page: 1, alwaysShow: true },
  { id: voiceCategory.TICKING_DOWN, name: 'Ticking down', page: 1, alwaysShow: true },
  { id: voiceCategory.CLEAR, name: 'Clear', page: 1, alwaysShow: true },
  { id: voiceCategory.CHEER, name: 'Cheer', page: 1, alwaysShow: true },
  { id: voiceCategory.COMPLIMENT, name: 'Compliment', page: 1, alwaysShow: true },
  { id: voiceCategory.HEARD, name: 'Heard', page: 1, alwaysShow: true },
  { id: voiceCategory.START, name: 'Start', page: 1, alwaysShow: true },
  { id: voiceCategory.LOSE, name: 'Lose', page: 1, alwaysShow: true },
  { id: voiceCategory.WAITING, name: 'Waiting', page: 1, alwaysShow: true },
  { id: voiceCategory.WON, name: 'Won', page: 1, alwaysShow: true },
  { id: voiceCategory.WINNING, name: 'Winning', page: 1, alwaysShow: true },
  { id: voiceCategory.SORRY, name: 'Sorry', page: 1, alwaysShow: true },
  { id: voiceCategory.LETS_GO, name: "Let's go", page: 1, alwaysShow: true },
  { id: voiceCategory.FRIENDLY_FIRE, name: 'Friendly fire', page: 1, alwaysShow: true },
  { id: voiceCategory.TEN_SECS, name: '10 secs', page: 1, alwaysShow: true },
  { id: voiceCategory.THANKS, name: 'Thanks', page: 1, alwaysShow: true },
  { id: voiceCategory.DECOY, name: 'Decoy', page: 1, alwaysShow: true },
  { id: voiceCategory.FIRE_MOLOTOV, name: 'Fire / Molotov', page: 1, alwaysShow: true },
  { id: voiceCategory.FLASHBANG, name: 'Flashbang', page: 1, alwaysShow: true },
  { id: voiceCategory.HE_GRENADE, name: 'HE Grenade', page: 1, alwaysShow: true },
  { id: voiceCategory.SMOKE, name: 'Smoke', page: 1, alwaysShow: true },
]

const pageTwoCategories: VoiceCategoryConfig[] = [
  { id: voiceCategory.ATTACK, name: 'Attack', page: 2, alwaysShow: true },
  { id: voiceCategory.COVERING, name: 'Covering', page: 2, alwaysShow: true },
  { id: voiceCategory.DISAGREE, name: 'Disagree', page: 2, alwaysShow: true },
  { id: voiceCategory.NONE_LEFT, name: '0 left', page: 2, alwaysShow: true },
  { id: voiceCategory.FOLLOWING, name: 'Following', page: 2, alwaysShow: true },
  { id: voiceCategory.I_KILLED_ENEMY, name: 'I killed enemy', page: 2, alwaysShow: true },
  { id: voiceCategory.PLANTING_DEFUSING, name: 'Planting / Defusing', page: 2, alwaysShow: true },
  { id: voiceCategory.IN_POSITION, name: 'In position', page: 2, alwaysShow: true },
  { id: voiceCategory.I_GOT_LAST, name: 'I got last', page: 2, alwaysShow: true },
  { id: voiceCategory.ON_MY_WAY, name: 'On my way', page: 2, alwaysShow: true },
  ...
  { id: voiceCategory.REQUEST_LEADER, name: 'Request Lead', page: 2, alwaysShow: true },
]

const pageThreeCategories: VoiceCategoryConfig[] = [
  { id: voiceCategory.BLINDED, name: 'Blinded', page: 3, alwaysShow: true },
  { id: voiceCategory.BOMB_PLANTED, name: 'Bomb planted', page: 3, alwaysShow: true },
  { id: voiceCategory.COUNTDOWN, name: 'Countdown', page: 3, alwaysShow: true },
  { id: voiceCategory.DEATH, name: 'Death', page: 3, alwaysShow: true },
  { id: voiceCategory.ONE_LEFT, name: '1 left', page: 3, alwaysShow: true },
  { id: voiceCategory.TWO_LEFT, name: '2 left', page: 3, alwaysShow: true },
  { id: voiceCategory.THREE_LEFT, name: '3 left', page: 3, alwaysShow: true },
  { id: voiceCategory.FRIEND_PLANTING, name: 'Planting friend', page: 3, alwaysShow: true },
  { id: voiceCategory.I_KILLED_SNIPER, name: 'I killed sniper', page: 3, alwaysShow: true },
  { id: voiceCategory.LOCATION_MID, name: 'Location Mid', page: 3, alwaysShow: true },
  { id: voiceCategory.PINNED, name: 'Pinned', page: 3, alwaysShow: true },
  { id: voiceCategory.REQUEST_BACKUP, name: 'Request Backup', page: 3, alwaysShow: true },
  ...
  { id: voiceCategory.REGROUP, name: 'Regroup', page: 3, alwaysShow: true },
  { id: voiceCategory.SCARED, name: 'Scared', page: 3, alwaysShow: true },
]
